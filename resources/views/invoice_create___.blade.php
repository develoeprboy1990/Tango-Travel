        ...
        <div class='row'>
          ...
          <tbody>
            <tr class="p-3">
              ...
              <td>
                <input type="number" name="Taxable[]"  id="Taxable_1" class=" form-control  totalLinePrice " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" >
              </td>
              <td>
