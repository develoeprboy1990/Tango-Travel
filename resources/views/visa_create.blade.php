...
<div class="page-title-box d-sm-flex align-items-center justify-content-between">
 <h4 class="mb-sm-0 font-size-18">Add Visa Detail</h4>
...
<div class="row">
 <div class="col-12">
    <form action="{{URL('/VisaSave')}}" method="post">
        {{csrf_field()}}
<div class="card">
<div class="card-body">
...
<div class="col-md-4">
<input class="form-control" type="text"   name="VisaNo" id="example-email-input" value="{{old('VisaNo')}}" required="">
</div>
</div>
...
<div class="col-md-4">
<input class="form-control" type="text"   name="PassangerName" id="example-email-input" value="{{old('PassangerName')}}" required="">
</div>
</div>
...
<div class="col-md-4">
 <div class="input-group" id="datepicker2">
  <input type="text" name="Date" autocomplete="off" class="form-control" placeholder="dd/mm/yyyy" data-date-format="dd/mm/yyyy" data-date-container="#datepicker2" data-provide="datepicker" data-date-autoclose="true" value="{{date('d/m/Y')}}" required="">
...
<div class="col-md-4">
 <div class="input-group" id="datepicker2">
  <input type="text" name="DueDate" autocomplete="off" class="form-control" placeholder="dd/mm/yyyy" data-date-format="dd/mm/yyyy" data-date-container="#datepicker2" data-provide="datepicker" data-date-autoclose="true" value="" required="">
  <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
    </div>
</div>
</div>
...
<div class="col-md-4">
<input class="form-control" type="text"   name="Nationality" id="example-email-input" value="{{old('Nationality')}}" required="">
</div>
</div>
...
<div class="col-md-9">
   <input type="submit" class="btn btn-primary w-md" value="Save"  >  
